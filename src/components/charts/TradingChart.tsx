...
import { generateCandleData } from '@/lib/forex-api';
...
export function TradingChart({ pair, signal }: TradingChartProps) {
  ...
  useEffect(() => {
    ...
    const candleData = generateCandleData(pair, timeframe, 150) as CandlestickData[];
  ...
  return (
    <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden">
      ...
      {/* Chart Legend */}
      {signal && (
        <div className="flex items-center gap-4 p-3 border-t border-gray-800 bg-gray-900/30">
